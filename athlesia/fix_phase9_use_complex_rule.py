...
print("[1] generalization_benchmark.rs lecserélve összetett szabályra.")
...
subprocess.run(["git", "commit", "-m", "Phase 9: benchmark uses ReflectH+Translate to demonstrate search cost reduction"], check=True)
